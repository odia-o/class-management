...
if(filter_has_var(INPUT_POST, 'submit')) {
  ...
  $(document).ready(function() {
    toastr.options.timeOut = 5000; // 1.5s
    toastr.error('sumtin went wrong');
  });
  </script>";
}
...
<html>
  ...
  $(document).ready(function() {
    toastr.options.timeOut = 5000; // 1.5s
    toastr.error('address deleted succesfully');
  });
  </script>";
}
        ?>
...
//                                            exit;
                                                ...
                                                foreach($all_users as $user) {
                                                    ...
                                                    echo "<td><a class='btn btn-danger' href='delete_address.php?gg={$user->id}&tf={$b->address_id}&tt={$_GET['gg']}'>delete address</a></td></tr>";
                                                }}
                                            ?>
                                        </tbody>
                                       </table>  
