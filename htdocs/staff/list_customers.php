                                ...
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php 
                                               $all_users = User::find_all_access("c");
                                                foreach($all_users as $user) {
                                                    echo "<tr><td>". $user->first_name. "</td>";
                                                    echo "<td>". $user->last_name. "</td>";
                                                    echo "<td>". $user->email. "</td>";
                                                    echo "<td><a type='button' class='btn btn-success' href='list_addresses.php?gg={$user->id}'>list address</a></td>";
                                                    echo "<td><a type='button' class='btn btn-danger' href='delete_customer.php?gg={$user->id}'>Delete customer</a></td></tr>";
